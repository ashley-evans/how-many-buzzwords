...
describe("store occurrences", () => {
    ...
    test("throws exception if an error occurs during DynamoDB insert", async () => {
        ...
        expect.assertions(1);
        await expect(
            repository.storeOccurrences(VALID_URL, [
    ...
    describe("given an empty array of occurrences", () => {
        ...
        beforeAll(async () => {
            ...
            response = await repository.storeOccurrences(VALID_URL, []);
        });
...
describe("get occurrences", () => {
    describe("given a URL with has associated occurrences", () => {
        ...
        test("calls DynamoDB with the provided URL and requests occurrences", () => {
